            ...
            return (
              <div key={idx} className="group border-t border-[#e2e2e2]">
                ...
                <button
                  ...
                  className="grid w-full grid-cols-1 gap-4 py-8 text-left md:grid-cols-[1fr_1fr_auto] md:items-center md:gap-8 cursor-pointer"
                >
                  <div>
                  ...
                  <div className="flex flex-wrap items-start gap-2 md:justify-end">
                    {exp.tags.map((tag) => (
                      <span
                        key={tag}
                        className={`rounded-full border border-[#e2e2e2] px-4 py-1.5 text-sm transition-colors duration-300 ${
                          isOpen
                            ? "bg-[#222222] text-[#f8f8f8]"
                            : "text-[#222222]"
                        } md:group-hover:bg-[#222222] md:group-hover:text-[#f8f8f8]`}
                      >
                        {tag}
                      </span>
                    ))}
                      ...
                      <div className="flex flex-1 items-center justify-between gap-4 sm:gap-6">
                        ...
                        <a
                          ...
                          className={`flex h-12 w-12 shrink-0 items-center justify-center rounded-full border transition-all duration-300 sm:h-14 sm:w-14 ${
                            isOpen
                              ? "bg-[#222222] text-[#f8f8f8] rotate-45 border-[#222222]"
                              : "border-[#cccccc] text-[#222222]"
                          } md:group-hover:bg-[#222222] md:group-hover:text-[#f8f8f8] md:group-hover:rotate-45 md:group-hover:border-[#222222]`}
                        >
                          <svg
                            xmlns="http://www.w3.org/2000/svg"
                            viewBox="0 0 24 24"
